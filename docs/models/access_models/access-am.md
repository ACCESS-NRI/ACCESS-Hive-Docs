[run_access-am3]: /models/run_a_model/run_access-am3
...
ACCESS-NRI has released the following [{{ model }} configurations][run_access-am3].

| Configuration | Description |
|---------------|-------------|
| n96e          | a low-resolution configuration based on the UKMO GC9 framework |
| n512e-aeroclim | a higher resolution configuration derived from the n96e setup but using prescribed climatological aerosols |
...
- **Land**: {{model}} uses [CABLE](/models/model_components/land#cable) for most land interactions, complemented by [JULES](/models/model_components/land#jules) for processes not available in CABLE.

[Run ACCESS-AM][run_access-am3]{: class="text-card"}