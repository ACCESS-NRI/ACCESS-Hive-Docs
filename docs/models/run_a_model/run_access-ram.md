...
{% set oas_id = "u-dk517" %}
{% set rns_id = "u-by395" %}
{% set branch_ras_rns = "nci_access_ram3" %}
...
1. **Copy the RAS from UKMO**<br>
    ```
    rosie checkout {{ ras_id }}/{{ branch_ras_rns }}
    ```
...
1. **Copy the RNS from UKMO**<br>
    ```
    rosie checkout {{ rns_id }}/{{ branch_ras_rns }}
    ```
...
The latest release branch of the RAS is `{{ branch_ras_rns }}`.
...
```
<terminal-window>
    <terminal-line data="input">rosie checkout {{ ras_id }}/{{ branch_ras_rns }}</terminal-line>
...
The latest release branch of the RNS is `{{ branch_ras_rns }}`.
