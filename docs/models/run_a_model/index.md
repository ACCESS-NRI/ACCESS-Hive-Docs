...
<div class="card-container">
    <!-- Rose/Cylc -->
    <a href="/models/run_a_model/rose_cylc" class="vertical-card aspect-ratio1to1">
        <div class="card-image-container">
            <img class="img-contain with-padding white-background" src="/assets/rose_cylc_logo.png" alt="Run models using Rose/Cylc">
        </div>
    ...
    <a href="run_access-issm" class="vertical-card aspect-ratio1to1">
        <div class="card-image-container">
            <img class="img-contain with-padding white-background" src="/assets/model-config-logos/model_visualisation/access_issm_model_visualisation.png" alt="ACCESS-ISSM">
        </div>
        <div class="card-text-container bold">   
            Run ACCESS-ISSM
        </div>
