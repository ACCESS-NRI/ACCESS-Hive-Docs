...
<div class="card-container">
    ...
    <a href="run_access-am3" class="vertical-card aspect-ratio1to1">
        <div class="card-image-container">
            <img class="img-contain with-padding white-background" src="/assets/model-config-logos/model_visualisation/access_esm_model_visualisation.png" alt="ACCESS-AM">
        </div>
        <div class="card-text-container bold">   
            Run ACCESS-AM3
        </div>
