...
!!! release
    [*ACCESS-MOPPy*](https://forum.access-hive.org.au/t/access-moppy-1-0-beta-release-announcement/5979) can be used with _ILAMB_ to CMOR-ise and evaluate ACCESS-ESM1.6 output. See the [workflow guide](https://access-moppy.readthedocs.io/en/latest/howto/cmorise_ilamb_workflow.html).
