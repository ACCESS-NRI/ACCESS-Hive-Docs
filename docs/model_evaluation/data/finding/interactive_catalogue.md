!!! release
    The ACCESS-NRI Interactive Data Catalogue is currently under development, and its functionality may differ from what is described in this page.
    For reliably retrieving ACCESS model data, please use the [ACCESS-NRI Intake Catalogue Python API](https://access-nri-intake-catalog.readthedocs.io/en/latest/index.html).

# ACCESS-NRI Interactive Data Catalog
