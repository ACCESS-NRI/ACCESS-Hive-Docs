...
Behaviours that are disrespectful to our members or activity’s participants or intimidate, exclude or cause discomfort to others will not be tolerated. We do not tolerate discrimination or harassment based on characteristics that include, but are not limited to: age, disability, gender, marriage and civil partnership, pregnancy and parenthood, race, religion or belief (or lack thereof), gender identity and expression, sexual orientation, technical choices,  experience level or any other dimension of diversity.
...
This document is adapted from guidelines from the [Society of Research Software Engineers Code of Conduct](https://society-rse.org/about/policies/code-of-conduct/), which was itself based on: [Mozilla participation guidelines](https://www.mozilla.org/en-US/about/governance/policies/participation/), the [Carpentries code of conduct](https://docs.carpentries.org/policies/coc/),  PyCon 2019 code of conduct and [Rust Code of conduct](https://www.rust-lang.org/policies/code-of-conduct) , all under CC-BY license. The Code of Conduct ACCESS-NRI is licensed under a Creative Commons 4.0 license. 
